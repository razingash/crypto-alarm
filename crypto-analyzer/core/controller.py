...
class BinanceAPIController:
    """
    данный контроллер следит за тем чтобы не пробить весовой лимит Binance.com/api и не получить автобан анализируя
    информацию полученую мидлвейром.Также он отвечает за выполнение запросов из класса BinanceApi
