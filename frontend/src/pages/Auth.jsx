        ...
        <div className={"section__main section__authentication"}>
            <div className={"field__authentication"}>
                ...
                <form onSubmit={registerUser}>
                    ...
                    {registerError?.error && <div className={"cell__error"}>{registerError?.error}</div>}
                ...
                <form onSubmit={loginUser}>
                    ...
                    {loginError?.username && <div className={"cell__error"}>{loginError?.username}</div>}
                    {loginError?.password && <div className={"cell__error"}>{loginError?.password}</div>}
                    {loginError?.error && <div className={"cell__error"}>{loginError?.error}</div>}
                    <div className={"auth__footer"}>
                        <div className={"reset__password"}>forgot password?</div>
